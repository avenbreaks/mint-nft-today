...
var web3 = new Web3("https://prettiest-frequent-water.matic-testnet.quiknode.pro/99a4d591bcb97d7465169dbd7b611e121f77ce29");
var account = web3.eth.accounts.privateKeyToAccount(process.env.PRIVATE_KEY);
web3.eth.accounts.wallet.add(account);

const ERC721 = new web3.eth.Contract(
  ERC721ABI,
  "0x8b0d87DEdF611bb157A537C18DBFF32711184499"
);
const ERC1155 = new web3.eth.Contract(
  ERC1155ABI,
  "0x320C4674Da9603408aba3551Ed561C9ae23A824d"
);
const ERC721_v1 = new web3.eth.Contract(
  ERC721V1ABI,
  "0x56F706f0b53e95b146311140D17A9E3A15651DDE"
);
const ERC1155_v1 = new web3.eth.Contract(
  ERC1155V1ABI,
  "0x31c02d6B1b5C38fEC00320C171E0FD9b33Bdd2a4"
);
